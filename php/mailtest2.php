...
<HR>
<?php require_once("/php/mailtest3.php"); ?>
  

<HR>
<H2><a href="/php/mailtest2.php">Test 2 : PHPMailer</a></H2>
<button onclick="window.location.href='/php/PHPMailer/src/PHPMailer.php'">Demander une réparation</button>
  <?php
